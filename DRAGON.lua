...
local UserName = (data.username_ or "SO_MARLY")
...
usertext = '\n☆ العضو ↣ ['..result.title_..'](t.me/'..(username or 'SO_MARLY')..')'
status  = '\n☆ تم ترقيته مطور'
...
usertext = '\n☆ العضو ↣ ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_MARLY')..')'
status  = '\n☆ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'☆ العضو ↣ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_MARLY')..') \n☆ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"☆ العضو : {["..data.first_name_.."](T.ME/SO_MARLY)}\n☆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "☆ عذرا ↣ {["..data.first_name_.."](T.ME/SO_MARLY)}\n☆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'☆ بواسطه ↣ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_MARLY')..') \n☆ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'☆ بواسطه ↣ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SO_MARLY')..') \n☆ تـم قفـل التاك بالكتم ')
end,nil)   
...
usertext = '\n ◉ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'SO_MARLY')..')'
status  = '\n ◉ تم ترقيته مدير عام'
texts = usertext..status
else
texts = ' ◉ لا يوجد حساب بهاذا المعرف'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n☆ لعضو ↣ ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_MARLY')..')'
status  = '\n☆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n☆ العضو ↣ '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n☆ العضو ↣ ['..result.title_..'](t.me/'..(text1[3] or 'SO_MARLY')..')'..'\n☆ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."SO_MARLY:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."SO_MARLY:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SO_MARLY:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SO_MARLY:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☆تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SO_MARLY:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SO_MARLY:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_MARLY')..')'
local iduser = result.sender_user_id_
